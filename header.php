				...
				<div id="modalMyAccount" class="modal">
				  ...
				  <form class="modal-content animate" action="/action_page.php">
					<div class="imgcontainer">
					  <span onclick="document.getElementById('modalMyAccount').style.display='none'" class="close" title="Close Modal">&times;</span>
					  <img src="http://sisterhoodevolution.com/wp-content/uploads/2018/10/main-logo-sisterhood-evolution.png" width="40%" alt="Sisterhood Evolution Main Logo" class="sisterhood-evolution">
					</div>
